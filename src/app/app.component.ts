...
export class AppComponent implements OnInit {
  ...
  async changeBGImage() {
    ...
    const result = await fetch('https://images.pexels.com/photos/956999/milky-way-starry-sky-night-sky-star-956999.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1', {
      method: 'HEAD'
    })
